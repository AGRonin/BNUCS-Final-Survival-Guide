...
# cpu版本未设置深度测试与视透视，渲染层次可能会有问题，但不影响物理模拟
# python mass_spring_3d.py --use-ggui -a "gpu"
# python mass_spring_3d.py -a "cpu"
...
if not use_ggui:
    ...
    gui = ti.GUI("Implicit Mass Spring System", res, 
                 show_gui=True, background_color=ti.rgb_to_hex((1, 1, 1)))  # 设置背景颜色为白色
    scene = ti.ui.Scene()
    camera = ti.ui.Camera()
