...
## 选课建议
推荐：走近医学（五级课）、跨文化交流与影像实践（艺术课，需要有一定视频制作相关能力）、男子健身健美·裴嘉文、马克思主义基本原理·王晓广、李晓光（老师还不错，想听的话可以听一听，不想听划水也没问题）

无功无过：概率统计与随机过程（逆天课程安排，仅针对课程）、离散数学、人工智能导论、数据结构、数字逻辑与数字系统、计算方法（可以选没问题）
